...
pub fn init(paths: &PersonaPaths, cli_debug: bool) -> Result<LoggingGuard> {
    ...
    let targets = Targets::new()
        ...
        .with_target("pos", level)
        .with_target("pos::qq", qq_level(level, cli_debug, env_value.is_some()));
