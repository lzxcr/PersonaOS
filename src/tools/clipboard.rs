...
fn read_clipboard_tool(args: Value, paths: PersonaPaths) -> Result<String> {
...
fn auto_result(paths: PersonaPaths) -> Result<String> {
    detected_text_result(paths)
}

fn detected_text_result(paths: PersonaPaths) -> Result<String> {
...
fn image_binary_result(img: crate::clipboard::ClipboardImage, paths: &PersonaPaths) -> Result<String> {
