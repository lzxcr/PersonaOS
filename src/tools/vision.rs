...
async fn analyze_image(args: Value, config: AppConfig, paths: PersonaPaths) -> Result<String> {
...
fn vision_client(config: &AppConfig, paths: &PersonaPaths) -> Result<OpenAiCompatibleClient> {
