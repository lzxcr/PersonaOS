...
mod tests {
    ...
    fn subagent_summary_keeps_current_internal_tool_without_raw_reasoning() {
        ...
        renderer
            ...
            .unwrap();
        renderer
            .write_tool_progress("task", "工具 #2：运行命令 · du -sh /home/alice/* 运行中")
            .unwrap();
        renderer
        ...
        assert!(summary.contains("↳ 工具 #2：运行命令 · du -sh /home/alice/* 运行中"));
    ...
    fn tool_subject_extracts_safe_operation_targets() {
        ...
        assert_eq!(
            tool_subject("run_command", r#"{"command":"du -sh /home/alice/*"}"#).as_deref(),
            Some("du -sh /home/alice/*")
        );
