...
impl HistoryStore {
    ...
    /// The caller must complete PersonaOS-admin authorization before invoking this.
    ...
    fn actor_sender(&self) -> Result<mpsc::Sender<Command>> {
        ...
        std::thread::Builder::new()
            .name("pos-message-history".to_string())
...
mod tests {
    ...
    async fn activity_ranking_is_scoped_stable_and_counts_recalled_messages() {
        ...
        assert_eq!(ranking.items[1].sender_name, "PersonaOS");
